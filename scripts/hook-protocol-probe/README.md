...
To re-validate against a new Claude Code version: follow the runbook at `docs/m0-runbook.md` and diff your findings against the M0 report at `docs/superpowers/specs/2026-04-27-m0-hook-protocol-validation-report.md`. Patch the architecture spec at `docs/superpowers/specs/2026-04-27-mneme-hook-architecture-design.md` if the protocol has shifted.
